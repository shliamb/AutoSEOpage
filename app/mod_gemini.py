...
# 7. Написание текста
# Задача: Создать текст по критериям SEO, продаж и увлекательности.
# Пример для ИИ:
# "Напиши вступление для статьи 'Как выбрать ноутбук для работы'. Упомяни боль ('тормозит старый ПК'), дай интригу ('5 критериев, о которых молчат продавцы'), используй ключевые слова ('ноутбук для офиса до 50000 руб')."
